...
<body class="bg-gray-100">
    ...
    <section class="px-20 py-8 max-md:px-4 max-md:py-4">
        <h1 class="text-3xl font-bricolage flex items-center gap-2 mb-4 italic"><a href="./../" class="flex items-center justify-center"><i class="bx bx-chevron-left"></i></a><span>Detail Menu</span></h1>
