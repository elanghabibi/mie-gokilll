...
<body class="bg-gray-100 min-h-screen pb-20">
    ...
    <section class="px-20 py-8 max-md:p-4 w-full space-y-6">
        <h1 class="text-4xl font-black font-bricolage italic uppercase tracking-tight text-gray-950 flex items-center gap-2">
            <a href="<?= $domain ?>" class="w-10 aspect-square flex border-2 border-black bg-white p-1 hover:shadow-none shadow-[2px_2px_0px_#000] transition-all"><i class="bx bx-chevron-left text-2xl flex"></i></a>
        ...
        <div id="main-cart-layout" class="flex w-full max-md:flex-col gap-8 items-start">
            
            <div class="col-span-2 space-y-4 w-3xl max-md:w-full" id="cart-items-container"></div>

            <div class="bg-white border-4 border-black p-6 shadow-[8px_8px_0px_#000] space-y-6 flex-1 max-md:w-full">
